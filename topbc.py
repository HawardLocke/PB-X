...
def gen_files(src_path, dst_path):
	...
	for file_name in os.listdir(abs_src_path):
		...
		os.system("protoc --descriptor_set_out=.%s%s.pb --proto_path=.%s --include_imports .%s%s" % (dst_path, file_name_without_ext, src_path, src_path, file_name))
